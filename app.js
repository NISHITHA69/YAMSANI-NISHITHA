...
function takeCommand(message) {
    if (message.includes('hey') || message.includes('hello')) {
        ...
        speak("You are name is NISHITHA");
    ...
    } else if (message.includes("open word") || message.includes("microsoft word")) {
        // Open Microsoft Word Online
        window.open("C:\ProgramData\Microsoft\Windows\Start Menu\Programs", "_blank");
        speak("Opening Microsoft Word Online...");
